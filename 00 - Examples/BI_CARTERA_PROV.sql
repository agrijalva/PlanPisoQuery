-- DELETE FROM BI_CCP_TEMPAS_1
-- DELETE FROM BI_CARTERA_PROVEEDORES_1

-- SELECT DISTINCT ltrim(rtrim(PER_PATERNO + ' ' + PER_MATERNO + ' ' + PER_NOMRAZON)) AS Nombre,CCP_IDPERSONA as ID,PER_RFC
-- OBJECT_ID( 'tempdb.dbo.#BI_CCP_TEMPAS' );

--DROP TABLE #CXC_TEMPPERSONAANT;
--DROP TABLE #BI_CARTERA_PLP;
--DROP TABLE #BI_CCP_TEMPAS;
-- DROP TABLE #CXC_TEMPPERSONAANT3;
...
--SELECT * FROM #BI_CARTERA_PLP WHERE convert(Datetime,ccp_fechaDOCTO,103) > convert(Datetime,@Fecha,103) 

-- SELECT * FROM #BI_CARTERA_PLP;

--INSERT INTO BI_CCP_TEMPAS_1 (MODULO, DES_CARTERA, DES_TIPODOCTO, CCP_IDDOCTO, CCP_NODOCTO, CCP_COBRADOR, CCP_IDPERSONA, Nombre,
-- CCP_FECHVEN, CCP_FECHPAG, CCP_FECHPROMPAG, CCP_FECHREV, CCP_CONCEPTO, CCP_REFERENCIA, CCP_OBSPAR, CCP_OBSGEN, IMPORTE, 
-- SALDO, DIAS, CCP_FECHADOCTO, CCP_REFER, CVEUSU, HORAOPE, DIASVENCIDOS, INTERESES, FECHAVENCIDO, CCP_GRUPO1,CCP_CARTERA,
-- GRUPO, TELEFONO1,CCP_VFTIPODOCTO,CCP_VFDOCTO,NOMBRE_REFERENCIAS,CCP_TIPODOCTO,CCP_ORIGENCON,VEH_NOINVENTA,CCP_CONTRARECIBO,
-- DPP,CCP_PORIVA,PER_RFC) 
SELECT 
...
--SET #BI_CCP_TEMPAS.pmm_observaciones = [par_pedmost].pmm_observaciones 
--FROM #BI_CCP_TEMPAS,par_pedmost 
--WHERE [par_pedmost].pmm_ref2 = #BI_CCP_TEMPAS.ccp_iddocto
